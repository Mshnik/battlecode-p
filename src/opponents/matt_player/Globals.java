...
//    public static RobotInfo[] attackableHostiles = null;
    ...
    public static final int GARDENER_LIFE_CHANNEL = 300;
    public static final int SCOUT_LIFE_CHANNEL = 301;
    public static final int LUMBERJACK_LIFE_CHANNEL = 302;
    public static final int SOLDIER_LIFE_CHANNEL = 303;
    ...
    public static Direction moveBounce(Direction dir) throws GameActionException {
    ...
    public static void funeralBroadcast() throws GameActionException {

...
public class Globals {
    ...
    public static Direction goalDirection;
...
//    public static RobotInfo[] attackableHostiles = null;
    ...
    /**
     * Moves the player until they hit a boundary,
     * and then chooses a new random direction for them to move in
     * @param dir proposed direction to move in
     * @return the direction that the robot should move, may be different if the robot cannot move in that direction
     * @throws GameActionException
     */
